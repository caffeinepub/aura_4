...
import type { Category as _Category, ClothingItem as _ClothingItem, ExternalBlob as _ExternalBlob, Shop as _Shop, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async _initializeShops(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor._initializeShops();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addClothingItem(arg0: string, arg1: ClothingItem): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addClothingItem(arg0, to_candid_ClothingItem_n8(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async attachPhotoToItem(arg0: string, arg1: ExternalBlob): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.attachPhotoToItem(arg0, await to_candid_ExternalBlob_n12(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getItemDetails(arg0: string): Promise<[ClothingItem, Array<Shop>]> {
        if (this.processError) {
            try {
                const result = await this.actor.getItemDetails(arg0);
                return [
                    from_candid_ClothingItem_n13(this._uploadFile, this._downloadFile, result[0]),
    ...
    async getItemPhoto(arg0: string): Promise<ExternalBlob | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getItemPhoto(arg0);
    ...
    async searchItems(arg0: Category | null, arg1: string | null, arg2: string | null, arg3: string | null): Promise<Array<ClothingItem>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchItems(to_candid_opt_n24(this._uploadFile, this._downloadFile, arg0), to_candid_opt_n25(this._uploadFile, this._downloadFile, arg1), to_candid_opt_n25(this._uploadFile, this._downloadFile, arg2), to_candid_opt_n25(this._uploadFile, this._downloadFile, arg3));
...
function from_candid_ClothingItem_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ClothingItem): ClothingItem {
...
function from_candid_Shop_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Shop): Shop {
...
function from_candid_record_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        clothing: from_candid_vec_n20(_uploadFile, _downloadFile, value.clothing),
        name: value.name,
        phone: value.phone,
...
function from_candid_variant_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "men" in value ? Category.men : "bridal" in value ? Category.bridal : "kids" in value ? Category.kids : "casual" in value ? Category.casual : "women" in value ? Category.women : value;
}
function from_candid_vec_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Shop>): Array<Shop> {
    return value.map((x)=>from_candid_Shop_n18(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_ClothingItem>): Array<ClothingItem> {
    return value.map((x)=>from_candid_ClothingItem_n13(_uploadFile, _downloadFile, x));
}
...
function to_candid_ClothingItem_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ClothingItem): _ClothingItem {
